...
class TransactionBuilder {
  ...
  build() {
    ...
    if (this.listOfUTXO == null) throw new ArgumentException('It\'s necessary to inform a list of unspent output transactions.');
    if (this.outputAddress == null) throw new ArgumentException('It\'s necessary to inform the destination address.');
    if (this.totalAmount == null) throw new ArgumentException('It\'s necessary to inform the transaction value.');
    ...
    if (changeAmount > 0) {
      ...
      throw new ArgumentException('The sender does not have enough to pay for the transaction.');
    }
